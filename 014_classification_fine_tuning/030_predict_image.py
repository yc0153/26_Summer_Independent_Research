...
path_model = os.path.join(dir_proj, "014_classification_fine_tuning",
                          "models", "resnet18_fine_tuned_shapes.pt")
dir_output = os.path.join(dir_proj, "014_classification_fine_tuning", "output")
