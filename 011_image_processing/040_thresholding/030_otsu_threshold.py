...
Otsu Threshold
==========================================================================================="""
# Otsu thresholding chooses the threshold automatically from the histogram.
threshold, otsu = cv2.threshold(src=gray, thresh=0, maxval=255,
                                type=cv2.THRESH_BINARY + cv2.THRESH_OTSU)

cv2.imwrite(filename=os.path.join(dir_output, "01_gray.png"), img=gray)
cv2.imwrite(filename=os.path.join(dir_output, "04_otsu_threshold.png"),
            img=otsu)
