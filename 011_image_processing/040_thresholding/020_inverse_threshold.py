...
Inverse Threshold
==========================================================================================="""
# Inverse thresholding makes dark objects white.
_, binary_inverse = cv2.threshold(src=gray, thresh=127, maxval=255,
                                  type=cv2.THRESH_BINARY_INV)

cv2.imwrite(filename=os.path.join(dir_output, "01_gray.png"), img=gray)
cv2.imwrite(filename=os.path.join(dir_output, "03_inverse_threshold.png"),
            img=binary_inverse)
