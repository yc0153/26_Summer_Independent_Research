...
Gaussian Blur
==========================================================================================="""
# Gaussian blur gives closer pixels more weight.
gaussian = cv2.GaussianBlur(src=noisy, ksize=(9, 9), sigmaX=0)

cv2.imwrite(filename=os.path.join(dir_output, "03_gaussian_blur.png"),
            img=gaussian)
