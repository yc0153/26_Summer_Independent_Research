...
Average Blur
==========================================================================================="""
# Average blur replaces each pixel with the average of nearby pixels.
blur = cv2.blur(src=noisy, ksize=(9, 9))

cv2.imwrite(filename=os.path.join(dir_output, "02_average_blur.png"), img=blur)
