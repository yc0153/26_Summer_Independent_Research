...
result = img.copy()
counts = {"circle": 0, "rectangle": 0, "triangle": 0}
...
for contour in contours:
    ...
    approx = cv2.approxPolyDP(curve=contour, epsilon=0.03 * perimeter,
                              closed=True)
